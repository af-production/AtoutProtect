    ...
    <body>
    	<ul class="navBar">
    		...
    		<?php 
	    		...
	    		{
	    			echo '<li class="navBar" style="float: right;"> <a href="/www/AtoutProtect/ApplicationWeb/view/frontend/deconnexion.php" <form name="deconnexion" method="post"> <input type="submit" value="Déconnexion" ></form> </a> 
						</li><li class="navBar" style="float: right;"> Connecté en tant que : '.$_SESSION['MailUtilisateur'].'</li>';
	    		}
	    		else
	    		{
